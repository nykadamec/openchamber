...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.debug': '除錯',
  'sessions.sidebar.footer.actions.update': '更新',
  'sessions.sidebar.footer.versionTooltip': '檢查更新',
  ...
  'sessions.sidebar.session.status.error': '會話錯誤',
