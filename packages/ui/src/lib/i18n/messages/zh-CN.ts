...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.debug': '调试',
  'sessions.sidebar.footer.actions.update': '更新',
  'sessions.sidebar.footer.versionTooltip': '检查更新',
  ...
  'sessions.sidebar.session.status.error': '会话错误',
