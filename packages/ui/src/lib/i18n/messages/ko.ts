...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.debug': '디버그',
  'sessions.sidebar.footer.actions.update': '업데이트',
  'sessions.sidebar.footer.versionTooltip': '업데이트 확인',
  ...
  'sessions.sidebar.session.status.error': '세션 오류',
