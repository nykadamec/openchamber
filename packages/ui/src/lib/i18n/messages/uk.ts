...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.footer.actions.debug": "Налагодження",
  "sessions.sidebar.footer.actions.update": "Оновити",
  "sessions.sidebar.footer.versionTooltip": "Перевірити наявність оновлень",
  ...
  "sessions.sidebar.session.status.error": "Помилка сесії",
